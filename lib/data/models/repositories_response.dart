...
class Repository {
  ...
  factory Repository.fromTabMap(Map<String, dynamic> json) => Repository(
        id: json["id"],
        nodeId: json["node_id"],
        name: json["name"],
        fullName: json["full_name"],
        ...
        watchersCount: json["watchers_count"],
        language: json["language"],
        hasIssues: json["has_issues"] == 1 ? true : false,
        hasProjects: json["has_projects"] == 1 ? true : false,
        hasDownloads: json["has_downloads"] == 1 ? true : false,
        hasWiki: json["has_wiki"] == 1 ? true : false,
        hasPages: json["has_pages"] == 1 ? true : false,
        hasDiscussions: json["has_discussions"] == 1 ? true : false,
        forksCount: json["forks_count"],
        mirrorUrl: json["mirror_url"],
        archived: json["archived"] == 1 ? true : false,
        disabled: json["disabled"] == 1 ? true : false,
        openIssuesCount: json["open_issues_count"],
        license:
            json["license"] == null ? null : License.fromMap(json["license"]),
        allowForking: json["allow_forking"] == 1 ? true : false,
        isTemplate: json["is_template"] == 1 ? true : false,
        webCommitSignoffRequired:
            json["web_commit_signoff_required"] == 1 ? true : false,
        topics: json["topics"].split(","),
        visibility: json["visibility"],
        forks: json["forks"],
        openIssues: json["open_issues"],
        watchers: json["watchers"],
  ...
  Map<String, dynamic> toTabMap() => {
        ...
        "watchers_count": watchersCount,
        "language": language,
        "has_issues": hasIssues == true ? 1 : 0,
        "has_projects": hasProjects == true ? 1 : 0,
        "has_downloads": hasDownloads == true ? 1 : 0,
        "has_wiki": hasWiki == true ? 1 : 0,
        "has_pages": hasPages == true ? 1 : 0,
        "has_discussions": hasDiscussions == true ? 1 : 0,
        "forks_count": forksCount,
        "mirror_url": mirrorUrl ?? "",
        "archived": archived == true ? 1 : 0,
        "disabled": disabled == true ? 1 : 0,
        "open_issues_count": openIssuesCount,
        "license_node_id": license?.nodeId,
        "allow_forking": allowForking == true ? 1 : 0,
        "is_template": isTemplate == true ? 1 : 0,
        "web_commit_signoff_required": webCommitSignoffRequired == true ? 1 : 0,
        "topics": topics?.join(',') ?? "",
        "visibility": visibility,
        "forks": forks,
        "open_issues": openIssues,
...
class Owner {
  ...
  factory Owner.fromTabMap(Map<String, dynamic> json) => Owner(
        login: json["login"],
        id: json["id"],
        nodeId: json["node_id"],
        avatarUrl: json["avatar_url"],
        ...
        type: json["type"],
        userViewType: json["user_view_type"],
        siteAdmin: json["site_admin"] == 1 ? true : false,
      );
